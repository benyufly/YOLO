...
def get_parser():
    ...
    parser.add_argument('--max_epoch', default=1000, help='epoch to train the network')
...
def train():
    ...
    if args.pretrained_model:
        ...
        def xavier(param):
            nn.init.xavier_uniform(param)  # xavier初始化，输入和输出的方差相同
    ...
    torch.save(lprnet.state_dict(), args.save_folder + args.save_weight_name)
